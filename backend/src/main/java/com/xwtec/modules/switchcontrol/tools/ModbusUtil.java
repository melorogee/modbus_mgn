...
public class ModbusUtil {
    ...
    public static int readDigitalInput(String ip, int port, int address, int slaveId) {
        ...
        try {
            ...
            ReadInputDiscretesRequest req = new ReadInputDiscretesRequest(address, 4);
    ...
    public static int readInputRegister(String ip, int port, int address,
        ...
        int data = 0;
            ...
            ReadInputRegistersRequest req = new ReadInputRegistersRequest(address, 4);
    ...
    public static int readDigitalOutput(String ip, int port, int address,
        ...
        int data = 0;
            ...
            ReadCoilsRequest req = new ReadCoilsRequest(address, 4);
    ...
    public static float readRegister(String ip, int port, int address,
                                   int slaveId) throws Exception{
        int data = 0;
            InetAddress addr = InetAddress.getByName(ip);
            ...
            con.setPort(port);
            con.connect();
            ReadMultipleRegistersRequest req = new ReadMultipleRegistersRequest(address, 8);
            req.setUnitID(slaveId);
            ...
            data = res.getRegisterValue(0);
            int data1=   res.getRegisterValue(1);
            String x = Integer.toHexString(data) + Integer.toHexString(data1);
            float result = Float.intBitsToFloat(Integer.parseInt(x,16))*0.1f;
            con.close();
...
//        System.out.println(readDigitalOutput("192.168.3.22",502,2,1));
//        writeDigitalOutput("192.168.3.22",502,1,2,0);
//        System.out.println(readDigitalOutput("192.168.3.22",502,2,1));
        readRegister("192.168.10.12",28899,8194,1);
//        float temp = byte2int_Float("450d7000".getBytes());
//        float temp =Float.intBitsToFloat(Integer.parseInt("450d7000",16));
