...
export async function getStudentList(params) {
  return request(baseApi + '/api/modbus_api/switch/getSwitchLog', {
    method: 'GET',
  });
}

//获取学生信息列表
export async function getElecList(params) {
  return request(baseApi + '/api/modbus_api/switch/getElecLog', {
    method: 'GET',
  });
}
...
export async function getStudentCourse(params) {
  return request(baseApi + '/api/modbus_api/switch/getSwitchList', {
    method: 'GET',
  });
}
...
export async function addClass(params) {
  return request(baseApi + '/api/modbus_api/switch/goControl', {
    method: 'POST',
    body: params,
  });
}
...
export async function goLogin(params) {
  return request('/api/modbus_api/switch/login', {
    method: 'POST',
    body: params,
  });
}
